...
import { ContainerPagination, TableContainer } from '../../../../res/components/Table/style';
import { ASCENDING_TOOLTIP, CANCEL_TOOLTIP, DESCENDING_TOOLTIP } from '../../../../res/components/Table/constants';
  ...
  return (
    <TableContainer isTablePopup={isTablePopup}>
      <TableCustom
        ...
        loading={{
          indicator: <img style={{ width: '70px', height: '70px' }} alt="" src={loadingIcon} />,
          spinning: isLoading,
        }}
